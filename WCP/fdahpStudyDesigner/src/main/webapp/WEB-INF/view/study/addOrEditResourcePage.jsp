      ...
      <div class="modal-dialog modal-lg" style="width:98%;">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body pt-xs pb-lg pl-xlg pr-xlg">
            <embed id="embedPdfId"
                   src="<spring:eval expression="@propertyConfigurer.getProperty('fda.imgDisplaydPath')" /><spring:eval expression="@propertyConfigurer.getProperty('cloud.bucket.name')" />/studyResources/${resourceBO.pdfUrl}"
