                ...
                <div class="panel-body  pt-none">
                  <div>
                    ...
                    <div>
                      <div class="thumb">
                        <img
                            src="<spring:eval expression="@propertyConfigurer.getProperty('fda.imgDisplaydPath')" /><spring:eval expression="@propertyConfigurer.getProperty('cloud.bucket.name')" />/studypages/${fn:escapeXml(studyPageBo.imagePath)}"
