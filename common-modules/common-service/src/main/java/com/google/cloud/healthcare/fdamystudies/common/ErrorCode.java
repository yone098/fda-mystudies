...
public enum ErrorCode {
  ...
  SITE_NOT_FOUND(404, "EC-0004", HttpStatus.NOT_FOUND.toString(), "Site not found"),
  ...
  CURRENT_PASSWORD_INVALID(
      400, "EC-0010", Constants.BAD_REQUEST, "Current password entered is invalid"),
  ...
  APP_NOT_FOUND(404, "EC-0013", HttpStatus.NOT_FOUND.toString(), "App not found"),

  STUDY_NOT_FOUND(404, "EC-0014", HttpStatus.NOT_FOUND.toString(), "Study not found"),
  ...
  USER_NOT_FOUND(404, "EC-0024", HttpStatus.NOT_FOUND.toString(), "User not found"),
  ...
  LOCATION_UPDATE_DENIED(
      403, "EC-0030", "Forbidden", "You do not have permission to update the location"),
  ...
  PARTICIPANT_REGISTRY_SITE_NOT_FOUND(
      400, "EC-0035", Constants.BAD_REQUEST, "Error in getting participants details"),
  ...
  CANNOT_UPDATE_ENROLLMENT_TARGET_FOR_CLOSE_STUDY(
      400, "EC-0038", Constants.BAD_REQUEST, "Enrollment target update failed for closed study"),
  ...
  MANAGE_SITE_PERMISSION_ACCESS_DENIED(
      403, "EC-0048", HttpStatus.FORBIDDEN.toString(), "You do not have permission to manage site"),

  SITE_NOT_EXIST_OR_INACTIVE(
      400, "EC-0049", Constants.BAD_REQUEST, "Site doesn't exists or is inactive"),

  INVALID_ONBOARDING_STATUS(
      400, "EC-0050", HttpStatus.BAD_REQUEST.toString(), "Allowed values are: N, D, I and E"),

  CANNOT_DECOMMISSION_SITE_FOR_OPEN_STUDY(
      400, "EC-0051", Constants.BAD_REQUEST, "Cannot decomission site as study type is open"),

  INVALID_USER_STATUS(400, "EC-0052", Constants.BAD_REQUEST, "Invalid user status"),

  CANNOT_ADD_SITE_FOR_OPEN_STUDY(
      403, "EC-0053", HttpStatus.FORBIDDEN.toString(), "Cannot add site to open study"),

  USER_ID_REQUIRED(400, "EC-0054", Constants.BAD_REQUEST, "User Id is required");
