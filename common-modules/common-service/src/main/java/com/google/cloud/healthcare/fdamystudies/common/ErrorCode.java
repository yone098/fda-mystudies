...
public enum ErrorCode {
  BAD_REQUEST(400, "EC-400", Constants.BAD_REQUEST,
  ...
  ENFORCE_PASSWORD_HISTORY(400, "EC-105", Constants.BAD_REQUEST,
      "Your new password cannot repeat any of your previous 10 passwords;"),

  EMAIL_EXISTS(409, "EC-101", Constants.BAD_REQUEST,
      "This email has already been used. Please try with a different email address."),

  EMAIL_SEND_FAILED_EXCEPTION(500, "EC-500", "Email Server Error",
  ...
  APPLICATION_ERROR(500, "EC-500", "Internal Server Error",
      "Sorry, an error has occurred and your request could not be processed. "
          + "Please try again later."),

  SITE_PERMISSION_ACEESS_DENIED(403, "EC-105", HttpStatus.FORBIDDEN.toString(),
      "Does not have permission to maintain site"),

  SITE_EXISTS(400, "EC-106", Constants.BAD_REQUEST,
      "Site exists with the given locationId and studyId"),

  LOCATION_ACCESS_DENIED(403, "EC-882", "Forbidden",
      "You do not have permission to view or add or update locations"),

  LOCATION_UPDATE_DENIED(403, "EC-882", "Forbidden",
  ...
  DEFAULT_SITE_MODIFY_DENIED(400, "EC_888", Constants.BAD_REQUEST,
      "Default site can't be modified"),

  ALREADY_DECOMMISSIONED(400, "EC_886", Constants.BAD_REQUEST,
      "Can't decommision an already decommissioned location"),

  CANNOT_DECOMMISSIONED(400, "EC_885", Constants.BAD_REQUEST,
      "This Location is being used as an active Site in one or more studies"
          + " and cannot be decomissioned"),

  CANNOT_REACTIVATE(400, "EC_887", Constants.BAD_REQUEST,
      "Can't reactivate an already active location"),
  ...
  NO_PERMISSION_TO_MANAGE_SITE(403, "EC_863", HttpStatus.FORBIDDEN.toString(),
      "You do not have permission to manage site"),

  SITE_NOT_FOUND(404, "EC-94", HttpStatus.NOT_FOUND.toString(), "Site not found"),

  CANNOT_DECOMMISSION_SITE_FOR_OPEN_STUDY(400, "EC-95", Constants.BAD_REQUEST,
      " Cannot decomission site as study type is open"),

  MANAGE_SITE_PERMISSION_ACCESS_DENIED(403, "EC-105", HttpStatus.FORBIDDEN.toString(),
      "You do not have permission to manage site"),

  OPEN_STUDY(403, "EC-989", HttpStatus.FORBIDDEN.toString(),
      "Cannot add participant to open study"),

  ENROLLED_PARTICIPANT(400, "EC-862", Constants.BAD_REQUEST, "Participant already enrolled"),

  SITE_NOT_EXIST_OR_INACTIVE(400, "EC-869", Constants.BAD_REQUEST,
      "Site doesn't exists or is inactive"),

  STUDY_PERMISSION_ACCESS_DENIED(403, "EC-105", HttpStatus.FORBIDDEN.toString(),
      "Does not have study permission"),

  PARTICIPANT_REGISTRY_SITE_NOT_FOUND(400, "EC-105", Constants.BAD_REQUEST,
  ...
  APP_PERMISSION_ACCESS_DENIED(403, "EC-815", HttpStatus.FORBIDDEN.toString(),
      "Does not have App permission"),

  INVALID_ONBOARDING_STATUS(400, "EC-816", HttpStatus.BAD_REQUEST.toString(),
      "allowed values: N, D, I and E"),

  CANNOT_DECOMMISSION_SITE_FOR_ENROLLED_ACTIVE_STATUS(400, "EC_885", Constants.BAD_REQUEST,
      "This Site is associated with active and enrolled participants"
          + " and cannot be decomissioned"),

  NOT_SUPER_ADMIN_ACCESS(403, "EC_870", HttpStatus.FORBIDDEN.toString(),
      "You are not authorized to access this information"),

  PERMISSION_MISSING(400, "EC_978", Constants.BAD_REQUEST,
      "Admin should have atleast one permission"), DOCUMENT_NOT_IN_PRESCRIBED_FORMAT(400, "EC_866",
          Constants.BAD_REQUEST, "Import Document not in prescribed format"),

  FAILED_TO_IMPORT_PARTICIPANTS(500, "EC_914", HttpStatus.INTERNAL_SERVER_ERROR.toString(),
  ...
  CANNOT_UPDATE_ENROLLMENT_TARGET_FOR_CLOSE_STUDY(400, "EC-95", Constants.BAD_REQUEST,
      " Cannot update enrollment target for closed study"),

  CANNOT_UPDATE_ENROLLMENT_TARGET_FOR_DECOMMISSIONED_SITE(400, "EC-95", Constants.BAD_REQUEST,
      " Cannot update enrollment target for decommissionned site"), CONSENT_DATA_NOT_AVAILABLE(400,
          "EC_885", Constants.BAD_REQUEST, "error getting consent data"),

  INVALID_APPS_FIELDS_VALUES(400, "EC-869", Constants.BAD_REQUEST,
      "allowed values for 'fields' are studies, sites"),

  USER_NOT_INVITED(400, "EC-869", Constants.BAD_REQUEST,
      "Provided emailId not exists or user not invited"),
  ...
  CLOUD_STORAGE_EXCEPTION(500, "EC-500", "Cloud Storage Exception",
  ...
  static class ErrorCodeSerializer extends StdSerializer<ErrorCode> {
    ...
    @Override
    public void serialize(ErrorCode error, JsonGenerator jsonGenerator,
