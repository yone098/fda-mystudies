...
public interface AuthInfoRepository extends JpaRepository<AuthInfoEntity, String> {
  ...
  @Query(
      "SELECT distinct a.deviceToken,a.deviceType FROM UserAppDetailsEntity u,AuthInfoEntity a where u.userDetails = a.userDetails and u.app.appId in (?1) and a.remoteNotificationFlag=1 and "
