...
public enum ParticipantManagerEvent implements AuditLogEvent {
  ...
  SIGNIN_FAILURE_UNREGISTER_USER(
      ...
      AUTH_SERVER,
      null,
      "A user attempted to sign-in with an unregistered username.",
      "SIGNIN_FAILURE_UNREGISTER_USER"),
  ...
  PASSWORD_HELP_REQUESTED(
      ...
      null,
      null,
      "Password help email requested by the user.",
      "PASSWORD_HELP_REQUESTED"),
  ...
  PASSWORD_HELP_EMAIL_SENT(
      ...
      null,
      null,
      "Password help email sent successfully.",
      "PASSWORD_HELP_EMAIL_SENT"),
  ...
  PASSWORD_RESET_EMAIL_SENT_FOR_LOCKED_ACCOUNT(
      ...
      null,
      null,
      "Password reset email sent to the user as a remediation to locked account.",
      "PASSWORD_RESET_EMAIL_SENT_FOR_LOCKED_ACCOUNT"),
  ...
  PASSWORD_HELP_EMAIL_SENT_FAILED(
      PARTICIPANT_DATASTORE,
      null,
      null,
      "Password help email failed to be sent to user.",
      "PASSWORD_HELP_EMAIL_SENT_FAILED"),
  ...
  SITE_ADDED_FOR_STUDY(
      ...
      null,
      null,
      "User successfully added site.(Site ${site}, Study -${study}, App -${app_name})",
      "SITE_ADDED_FOR_STUDY"),
  ...
  PARTICIPANT_EMAIL_ADD_SUCCESS(
      ...
      null,
      null,
      "Participant email added successfully.(Site-${site}, Study-${study_name}, App-${app_name})",
      "PARTICIPANT_EMAIL_ADD_SUCCESS"),
  ...
  PARTICIPANT_EMAIL_ADD_FAILURE(
      ...
      null,
      null,
      "Participant email failed to be added as email id already exist.(Site-${site}, Study-${study_name}, App-${app_name})",
      "PARTICIPANT_EMAIL_ADD_FAILURE"),
  ...
  PARTICIPANT_DETAILS_ACCESS_SUCCESS(
      ...
      null,
      null,
      "User successfully accessed Participant details.(Site- ${site}, Study-${study_name}, App-${app_name},Enrolment Status -${enrolment_status}, Date of enrolment ${date_of_enrolment},Date of withdrawal ${date_of_withdrawal},Onboarding Status ${onboarding_status}, Last Invitation Sent ${last_invitation_date})",
      "PARTICIPANT_DETAILS_ACCESS_SUCCESS"),
  ...
  PARTICIPANT_DETAILS_ACCESS_FAILURE(
      ...
      null,
      null,
      "User failed to access Participant details.(Site- ${site}, Study-${study_name}, App-${app_name},Enrolment Status -${enrolment_status}, Date of enrolment ${date_of_enrolment},Date of withdrawal ${date_of_withdrawal},Onboarding Status ${onboarding_status}, Last Invitation Sent ${last_invitation_date})",
      "PARTICIPANT_DETAILS_ACCESS_FAILURE"),
  ...
  RESEND_INVITATION_FOR_PARTICIPANT_SUCCESS(
      ...
      null,
      null,
      "Resend study invitation email successful to participant.(Site-${site}, Study-${study_name}, App-${app_name}, Enrolment Status -${enrolment_status}, Last Invited date ${last_invited_date})",
      "RESEND_INVITATION_FOR_PARTICIPANT_SUCCESS"),
  ...
  RESEND_INVITATION_FOR_PARTICIPANT_FAILURE(
      ...
      null,
      null,
      "Resend study invitation email failed to participant.(Site-${site}, Study-${study_name}, App-${app_name}, Enrolment Status -${enrolment_status},Last Invited date ${last_invited_date})",
      "RESEND_INVITATION_FOR_PARTICIPANT_FAILURE"),
  ...
  DISABLE_INVITATION_SUCCESS(
      ...
      null,
      null,
      "Participant study invitation disabled successfully.(Site-${site}, Study-${study_name}, App-${app_name})",
      "DISABLE_INVITATION_SUCCESS"),
  ...
  DISABLE_INVITATION_FAILURE(
      ...
      null,
      null,
      "Participant study invitation failed to disable.(Site-${site}, Study-${study_name}, App-${app_name})",
      "DISABLE_INVITATION_FAILURE"),
  ...
  STUDY_INVITE_SENT_FOR_PARTICIPANT_SUCCESS(
      ...
      null,
      null,
      "Study invitation email to participant sent successful.(Site-${site}, Study-${study_name}, App-${app_name})",
      "STUDY_INVITE_SENT_FOR_PARTICIPANT_SUCCESS"),
  ...
  STUDY_INVITE_SENT_FOR_PARTICIPANTS_FAILED(
      ...
      null,
      null,
      "Study invitation email to participant sent failed.(Site-${site}, Study-${study_name}, App-${app_name}.Status-${status})",
      "STUDY_INVITE_SENT_FOR_PARTICIPANTS_FAILED"),
  ...
  STUDY_INVITATION_ENABLED_FOR_PARTICIPANT_SUCCESSFUL(
      ...
      null,
      null,
      "Participant study invitation email enabled successful.(Study-${study_name}, App-${app_name}, Date of disabled -${disabled_date}, Enrolment Status -${enrolment_status})",
      "STUDY_INVITATION_ENABLED_FOR_PARTICIPANT_SUCCESSFUL"),
  ...
  STUDY_INVITATION_ENABLE_PARTICIPANTS_FAILED(
      ...
      null,
      null,
      "Participant study invitation email failed to enable.(Study-${study_name}, App-${app_name},Date of disabled -${disabled_date}, Enrolment Status -${enrolment_status})",
      "STUDY_INVITATION_ENABLE_PARTICIPANTS_FAILED"),
  ...
  SEARCH_SITE_ID_OR_PARTICIPANT_EMAIL_ID_FAILURE(
      ...
      null,
      null,
      "User search by site id or participant email id in study participant registery failed.(Site-${site}, Study-${study_name})",
      "SEARCH_SITE_ID_OR_PARTICIPANT_EMAIL_ID_FAILURE"),
  ...
  SEARCH_PARTICIPANT_EMAIL_ID_SUCCESS(
      ...
      null,
      null,
      "User search for participant email id in app registry successful.",
      "SEARCH_PARTICIPANT_EMAIL_ID_SUCCESS"),
  ...
  SEARCH_PARTICIPANT_EMAIL_ID_FAILURE(
      ...
      null,
      null,
      "User search for participant email id in app registry failed.",
      "SEARCH_PARTICIPANT_EMAIL_ID_FAILURE"),
  ...
  SEARCH_BY_USER_NAME_OR_EMAIL(
      ...
      null,
      null,
      "User search for user name or email in users page success.(${user_id} , )",
      "SEARCH_BY_USER_NAME_OR_EMAIL"),
  ...
  SEARCH_BY_USER_NAME_OR_EMAIL_FAILURE(
      ...
      null,
      null,
      "User search for user name or email in users page failed.(${user_id} , )",
      "SEARCH_BY_USER_NAME_OR_EMAIL_FAILURE"),
  ...
  NEW_USER_BASIC_DETAILS_SUCCESS(
      ...
      null,
      null,
      "Basic details of new user captured successful.(New user- ${user_id},Role - ${role}, Status- ${status})",
      "NEW_USER_BASIC_DETAILS_SUCCESS"),
  ...
  NEW_USER_BASIC_DETAILS_FAILURE(
      ...
      null,
      null,
      "New user basic details captured failed.(new user- ${user_id},Role - ${role}, Status- ${status})",
      "NEW_USER_BASIC_DETAILS_FAILURE"),
  ...
  NEW_USER_LOCATION_PERMISSION_SUCCESSFUL(
      ...
      null,
      null,
      "Permission location of newly added user set successful.(new user- ${user_id}, Role - ${role}, location permission - ${location_permission)}",
      "NEW_USER_LOCATION_PERMISSION_SUCCESSFUL"),
  ...
  NEW_USER_LOCATION_PERMISSION_FAILURE(
      ...
      null,
      null,
      "Permission location of newly added user failed.(new user- ${user_id}, Role - ${role}, Status- ${status}",
      "NEW_USER_LOCATION_PERMISSION_FAILURE"),
  ...
  NEW_USER_APP_DETAILS_ADDED_SUCCESSFUL(
      ...
      null,
      null,
      "App details added successfully for new user.(new user- ${user_id}, Role - ${role}, Status- ${status}, App associated - ${apps}, App ID - ${app_id})",
      "NEW_USER_APP_DETAILS_ADDED_SUCCESSFUL"),
  ...
  NEW_USER_APP_DETAILS_ADDED_FAILURE(
      ...
      null,
      null,
      "App details failed to be add for new user.(new user- ${user_id},Role - ${role}, Status- ${status}, App associated - ${apps}, App ID - ${app_id})",
      "NEW_USER_APP_DETAILS_ADDED_FAILURE"),
  ...
  NEW_USER_APP_PERMISSION_SET_SUCCESSFUL(
      ...
      null,
      null,
      "App permission set successful for the new user.(new user- ${user_id}, Role - ${role}, Status- ${status}, App associated - ${apps}, App ID - ${app_id}, App permission- ${app_permission})",
      "NEW_USER_APP_PERMISSION_SET_SUCCESSFUL"),
  ...
  NEW_USER_APP_PERMISSION_SET_FAILURE(
      ...
      null,
      null,
      "App permission set failed for new user.(new user- ${user_id}, Role - ${role}, App ID - ${app_id}, App permission- ${app_permission})",
      "NEW_USER_APP_PERMISSION_SET_FAILURE"),
  ...
  NEW_USER_STUDY_PERMISSION_SET_SUCCESSFUL(
      ...
      null,
      null,
      "Study permission set successful for new user.(new user- ${user_id}, Role - ${role}, App ID - ${app_id}, App permission- ${app_permission}, Study Permission -${study_permission},Study name - ${study_name})",
      "NEW_USER_STUDY_PERMISSION_SET_SUCCESSFUL"),
  ...
  NEW_USER_STUDY_PERMISSION_SET_FAILURE(
      ...
      null,
      null,
      "Study permission failed for new user.(user- ${user_id}, Role - ${role}, App ID - ${app_id}, App permission- ${app_permission}, Study Permission -${study_permission},Study name - ${study_name})",
      "NEW_USER_STUDY_PERMISSION_SET_FAILURE"),
  ...
  NEW_USER_SITE_PERMISSION_SET_SUCCESSFUL(
      ...
      null,
      null,
      "Site permission set successfully for new user.(new user- ${user_id},Role - ${role}, App ID - ${app_id},Study name - ${study_name}, Site name - ${site_name}, Site permission- ${site_permission})",
      "NEW_USER_SITE_PERMISSION_SET_SUCCESSFUL"),
  ...
  NEW_USER_SITE_PERMISSION_SET_FAILURE(
      ...
      null,
      null,
      "Site permission failed to be set for new user. (new user- ${user_id},Role - ${role}, App ID - ${app_id},Study name - ${study_name}, Site name - ${site_name}, Site permission- ${site_permission})",
      "NEW_USER_SITE_PERMISSION_SET_FAILURE"),
  ...
  NEW_USER_CREATED_SUCCESS(
      ...
      null,
      null,
      "New user created created successfully.(User id- ${user_id})",
      "NEW_USER_CREATED_SUCCESS"),
  ...
  NEW_USER_CREATED_FAILURE(
      ...
      null,
      null,
      "New user creation failed.(User id- ${user_id})",
      "NEW_USER_CREATED_FAILURE"),
  ...
  NEW_USER_INVITATION_EMAIL_SUCCESSFUL(
      ...
      null,
      null,
      "User invitation email sent successful.(User id- ${user_id})",
      "NEW_USER_INVITATION_EMAIL_SUCCESSFUL"),
  ...
  NEW_USER_INVITATION_EMAIL_FAILURE(
      ...
      null,
      null,
      "User invitation email sent failed.(User id- ${user_id})",
      "NEW_USER_INVITATION_EMAIL_FAILURE"),
  ...
  USER_DETAILS_VIEWED_SUCCESSFUL(
      ...
      null,
      null,
      "User details viewed successfully.(user- ${user_id},Role - ${role}, Status- ${status}, App associated - ${apps}).",
      "USER_DETAILS_VIEWED_SUCCESSFUL"),
  ...
  USER_DETAILS_VIEWED_FAILURE(
      ...
      null,
      null,
      "User details viewed failed.(user- ${user_id},Role - ${role}, Status- ${status}, App associated - ${apps}).",
      "USER_DETAILS_VIEWED_FAILURE"),
  ...
  USER_ROLE_UPDATED_SUCCESSFUL(
      ...
      null,
      null,
      "User role updated successful. (user- ${user_id},Role changed from ${old_role} to ${new_role}, Status- ${status}, App associated - ${apps}).",
      "USER_ROLE_UPDATED_SUCCESSFUL"),
  ...
  USER_ROLE_UPDATED_FAILURE(
      ...
      null,
      null,
      "User role failed to update.(user- ${user_id},Role -{role},Status- ${status}, App associated - ${apps}).",
      "USER_ROLE_UPDATED_FAILURE"),

  USER_LOCATION_PERMISSION_ADDED_SUCCESSFUL(
      PARTICIPANT_DATASTORE,
      null,
      null,
      "Location permission for user added successful (user- ${user_id},Role - ${role}, location permission - ${location_permission)}",
      "USER_LOCATION_PERMISSION_ADDED_SUCCESSFUL"),

  USER_LOCATION_PERMISSION_FAILED_TO_ADD(
      PARTICIPANT_DATASTORE,
      null,
      null,
      "Location permission failed to add for user (user- ${user_id},Role - ${role}, Status- ${status}",
      "USER_LOCATION_PERMISSION_FAILED_TO_ADD"),
  ...
  USER_APP_ADDED_SUCCESSFUL(
      ...
      null,
      null,
      "App added successfully for user (user- ${user_id},Role - ${role}, Status- ${status}, App associated - ${apps}, App ID - ${app_id})",
      "USER_APP_ADDED_SUCCESSFUL"),
  ...
  USER_APP_ADDED_FAILURE(
      ...
      null,
      null,
      "App failed to add for user (user- ${user_id},Role - ${role}, Status- ${status}, App associated - ${apps}, App ID - ${app_id})",
      "USER_APP_ADDED_FAILURE"),
  ...
  USER_APP_DELETED_SUCCESSFUL(
      ...
      null,
      null,
      "App associated for the user deleted successful (user- ${user_id},Role - ${role}, Status- ${status}, App associated - ${apps}, App ID - ${app_id})",
      "USER_APP_DELETED_SUCCESSFUL"),

  USER_APP_DELETED_FAILED(
      PARTICIPANT_DATASTORE,
      null,
      null,
      "App associated for the user deleted failure (user- ${user_id},Role - ${role}, Status- ${status}, App associated - ${apps}, App ID - ${app_id}).",
      "USER_APP_DELETED_FAILED"),
  ...
  USER_APP_PERMISSION_UPDATE_SUCCESSFUL(
      ...
      null,
      null,
      "App permission update successful for the user (user- ${user_id},Role - ${role}, Status- ${status}, App associated - ${apps}, App ID - ${app_id}, App permission- ${app_permission})",
      "USER_APP_PERMISSION_UPDATE_SUCCESSFUL"),
  ...
  USER_APP_PERMISSION_UPDATE_FAILURE(
      ...
      null,
      null,
      "App permission update failed for user (user- ${user_id},Role - ${role}, App ID - ${app_id}, App permission- ${app_permission})",
      "USER_APP_PERMISSION_UPDATE_FAILURE"),
  ...
  USER_STUDY_SELECTED_SUCCESSFUL(
      ...
      null,
      null,
      "Study selected for user successful (user- ${user_id},Role - ${role}, App ID - ${app_id},Study Permission -${study_permission},Study name - ${study_name})",
      "USER_STUDY_SELECTED_SUCCESSFUL"),
  ...
  USER_STUDY_SELECTED_FAILURE(
      ...
      null,
      null,
      "Study selected for user failed (user- ${user_id},Role - ${role}, App ID - ${app_id},Study Permission -${study_permission},Study name - ${study_name})",
      "USER_STUDY_SELECTED_FAILURE"),
  ...
  USER_STUDY_PERMISSION_UPDATE_SUCCESSFUL(
      ...
      null,
      null,
      "Study permission updated successful for user (user- ${user_id},Role - ${role}, App ID - ${app_id},Study name - ${study_name}), Study Permission -${study_permission}",
      "USER_STUDY_PERMISSION_UPDATE_SUCCESSFUL"),
  ...
  USER_STUDY_PERMISSION_UPDATE_FAILURE(
      ...
      null,
      null,
      "Study permission updation failed for user (user- ${user_id},Role - ${role}, App ID - ${app_id},Study name - ${study_name}), Study Permission -${study_permission}",
      "USER_STUDY_PERMISSION_UPDATE_FAILURE"),
  ...
  USER_SITE_SELECTED_SUCCESSFUL(
      ...
      null,
      null,
      "Site selected for user successful (user- ${user_id},Role - ${role}, App ID - ${app_id},Study name - ${study_name}, Site name - ${site_name}, Site permission- ${site_permission})",
      "USER_SITE_SELECTED_SUCCESSFUL"),

  USER_SITE_SELECTED_FAILED(
      PARTICIPANT_DATASTORE,
      null,
      null,
      "Site selected for user failed (user- ${user_id},Role - ${role}, App ID - ${app_id},Study name - ${study_name}, Site name - ${site_name}, Site permission- ${site_permission})",
      "USER_SITE_SELECTED_FAILED"),
  ...
  USER_SITE_PERMISSION_UPDATE_SUCCESSFUL(
      ...
      null,
      null,
      "Site permission set successfully for user- (user- ${user_id},Role - ${role}, App ID - ${app_id},Study name - ${study_name}, Site name - ${site_name}, Site permission- ${site_permission})",
      "USER_SITE_PERMISSION_UPDATE_SUCCESSFUL"),
  ...
  USER_SITE_PERMISSION_UPDATE_FAILURE(
      ...
      null,
      null,
      "Site permission failed for user- (user- ${user_id},Role - ${role}, App ID - ${app_id},Study name - ${study_name}, Site name - ${site_name}, Site permission- ${site_permission})",
      "USER_SITE_PERMISSION_UPDATE_FAILURE"),
  ...
  USER_ACCOUNT_DEACTIVATION_SUCCESSFUL(
      ...
      null,
      null,
      "User account deactivated successfully (user- ${adminuser_id}).",
      "USER_ACCOUNT_DEACTIVATION_SUCCESSFUL"),
  ...
  USER_ACCOUNT_DEACTIVATED_FAILURE(
      ...
      null,
      null,
      "User account deactivation failed (user- ${adminuser_id}).",
      "USER_ACCOUNT_DEACTIVATED_FAILURE"),
  ...
  USER_ACCOUNT_ACTIVATED(
      ...
      null,
      null,
      "User account activated successful (user- ${adminuser_id}).",
      "USER_ACCOUNT_ACTIVATED"),
