...
public enum ApiEndpoint {
  ...
  SET_UP_ACCOUNT("http://localhost:8080/participant-manager-service/users/setUpAccount"),

  PATCH_USER("http://localhost:8080/participant-manager-service/users/{userId}"),

  DELETE_USER("http://localhost:8080/participant-manager-service/users/{userId}"),
