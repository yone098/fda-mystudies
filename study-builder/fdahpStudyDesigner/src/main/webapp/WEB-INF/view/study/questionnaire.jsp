        ...
        <form:form
          ...
          <div class="oneTime all mt-lg">
            <div class="gray-xs-f mb-sm">
              ...
              <span class="requiredStar">*</span>
             <%--  <c:if
                  test="${ fn:length(anchorTypeList) le 0}"> --%>
              <span
                    ...
                    <span
                      ...
                      <span class="gray-xs-f">Start date
                       ...
                       <!--  <span
                            ...
                            data-toggle="tooltip"
                            data-placement="bottom"
                            title="Selected dates and times will work as per the mobile device time. Selections of dates or times in the past (as per the server timezone which is EST) is not allowed..">
                        </span> -->
                      </span>
                      <br/>
                      <span class="pr-md">Anchor
      ...
      $('.time-opts').each(function () {
        ...
        if (dt) {
          ...
          if ($(timeId).val() && dt == today && moment($(timeId).val(), 'h:mm a').toDate()
            ...
            $(timeId).parent().find(".help-block").html(
    ...
    $(document).on('dp.change change', '.cusStrDate, .cusEndDate, .cusTime', function (e) {
      ...
      if (!chkVal) {
        ...
        $(thisAttr).parents('.manually-option').find('.cusTime').parent().removeClass(
            'has-error has-danger').find(".help-block").addClass('with-errors').html('');
      }
      var a = 0;
